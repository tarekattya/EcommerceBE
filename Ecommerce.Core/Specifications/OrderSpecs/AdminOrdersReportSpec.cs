...
/// <summary>Orders for admin report: filter by date range, status, amount (no email filter).</summary>
public class AdminOrdersReportSpec : BaseSpecifications<Order>
{
    public AdminOrdersReportSpec(OrderSpecParams specParams)
        : base(o =>
            ...
            (string.IsNullOrEmpty(specParams.Search) || o.BuyerEmail.Contains(specParams.Search!)))
    {
        ...
        if (!string.IsNullOrEmpty(specParams.Sort))
        {
            switch (specParams.Sort)
            {
                ...
                case "TotalAsc": AddOrderBy(o => o.SubTotal); break;
                case "TotalDesc": AddOrderByDesc(o => o.SubTotal); break;
