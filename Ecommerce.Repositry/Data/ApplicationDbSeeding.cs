...
public static class ApplicationDbSeeding
{
    public static async Task SeedAsync(ApplicationDbContext dbContext)
    {
        ...
        // Seed Coupons (RowVersion is auto-generated by SQL Server; do not include in INSERT)
        if (dbContext.Coupons.Count() == 0)
        {
            var createdAt = DateTime.UtcNow;
            
            await dbContext.Database.ExecuteSqlRawAsync(
                @"INSERT INTO Coupons (Code, DiscountValue, DiscountType, ExpiryDate, MinimumAmount, UsageLimit, UsageCount, IsActive, CreatedAt, IsDeleted)
                  VALUES ('WELCOME10', 10, 0, {0}, 50, 100, 0, 1, {1}, 0)",
                DateTime.UtcNow.AddMonths(3), createdAt);
            
            await dbContext.Database.ExecuteSqlRawAsync(
                @"INSERT INTO Coupons (Code, DiscountValue, DiscountType, ExpiryDate, MinimumAmount, UsageLimit, UsageCount, IsActive, CreatedAt, IsDeleted)
                  VALUES ('SAVE20', 20, 0, {0}, 100, 50, 0, 1, {1}, 0)",
                DateTime.UtcNow.AddMonths(6), createdAt);
            
            await dbContext.Database.ExecuteSqlRawAsync(
                @"INSERT INTO Coupons (Code, DiscountValue, DiscountType, ExpiryDate, MinimumAmount, UsageLimit, UsageCount, IsActive, CreatedAt, IsDeleted)
                  VALUES ('FIXED50', 50, 1, {0}, 200, NULL, 0, 1, {1}, 0)",
                DateTime.UtcNow.AddMonths(2), createdAt);
            
            await dbContext.Database.ExecuteSqlRawAsync(
                @"INSERT INTO Coupons (Code, DiscountValue, DiscountType, ExpiryDate, MinimumAmount, UsageLimit, UsageCount, IsActive, CreatedAt, IsDeleted)
                  VALUES ('FREESHIP', 0, 2, {0}, 50, 200, 0, 1, {1}, 0)",
                DateTime.UtcNow.AddMonths(1), createdAt);
            
            await dbContext.Database.ExecuteSqlRawAsync(
                @"INSERT INTO Coupons (Code, DiscountValue, DiscountType, ExpiryDate, MinimumAmount, UsageLimit, UsageCount, IsActive, CreatedAt, IsDeleted)
                  VALUES ('BOGO50', 50, 3, {0}, NULL, 30, 0, 1, {1}, 0)",
                DateTime.UtcNow.AddMonths(4), createdAt);
        }
