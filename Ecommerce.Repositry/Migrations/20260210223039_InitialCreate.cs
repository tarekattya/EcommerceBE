        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductItemOrderd_ProductId = table.Column<int>(type: "int", nullable: false),
                    ProductItemOrderd_ProductVariantId = table.Column<int>(type: "int", nullable: true),
                    ProductItemOrderd_Size = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProductItemOrderd_Color = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProductItemOrderd_Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProductItemOrderd_Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProductItemOrderd_PictureUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Price = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "DisplayName", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "OTPCode", "OTPExpiry", "OTPToken", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "6dc6528a-b280-4770-9eae-82671ee81ef7", 0, "99d2bbc6-bc54-4248-a172-a77de3ae4430", "Ecommerce Admin", "admin@Ecommerce.com", true, false, null, "ADMIN@ECOMMERCE.COM", "ADMIN@ECOMMERCE.COM", null, null, null, "AQAAAAIAAYagAAAAEOH6D/vkD9oFT+v/vYCeVxgFl3vfVYP9jcJXBCGU6Wzy2pOoVMQk4MGaGg+vJf7vAg==", null, false, "55BF92C9EF0249CDA210D85D1A851BC9", false, "admin@Ecommerce.com" });
